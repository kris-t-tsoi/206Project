...
public class MediaPlayerJFrame extends JFrame {
	...
	public MediaPlayerJFrame(String name) {
		...
		//Create a JSlider with 0 and 100 as the volume limits. 50 is the default.
		...
		//Windowbuilder generated code below, enter at your own risk
				...
				gl_contentPane.setHorizontalGroup(
					gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_contentPane.createSequentialGroup()
							.addContainerGap()
							.addComponent(sliderVolume, GroupLayout.DEFAULT_SIZE, 525, GroupLayout.PREFERRED_SIZE)
							.addContainerGap())
				);
